...
\marginnote{\think{Explore text editor}}[.5in] Today, you will view and
improve another Java program in {\tt gvim}! To load the source code of today's
Java program into \program{gvim}, you should type \command{gvim
src/main/java/labthree/TipCalculator.java} in your terminal window. This should
...
(lower case). Once you do this, the window should show \command{--INSERT--} in
...
Your program will produce nine additional lines of output once you add eight
more \command{System.out.println} statements. Unlike your previous Java
programs, this Java program must read input values from a file and then use
these inputs to perform computations and to produce outputs. Please see the Java
source code comments for more details! The remainder of this section summarizes
the purpose of this program for tip calculation.
...
% Whenever you are finished typing Java code in \program{gvim}, press the ESC key
...
cannot build \mainprogram{} correctly, then please talk with a teaching
assistant or the instructor. Finally, please make sure that you discuss the
...
your experiences with the various commands and Java code segments.
...
\item Students who want to learn more about how to use the {\tt Scanner} class
  can refer to Section 2.6 of the textbook, focusing on the {\tt GasMileage}
  class provided in Listing 2.9.
