...
descriptive commit message about the defect that you fixed"}}
...
like
``Allegheny-Computer-Science-100-Fall-2018/computer-science-100-fall-2018-practical-2-gkapfham''.
...
you find defects in the provided code:
...
compiler errors --- your task is to find and fix these problems! Once your
program is building correctly, fulfilling at least some of the assignment's
...
typing \gitpush{} and then checking to see that the transfer to GitHub is
successful.

% If you notice that transferring your code or writing to GitHub did
...
% Also, once your program is building correctly, fulfilling at least some of the
...
% successful. If you notice that transferring your Java source code to GitHub
...
% Students do not need to submit printed source code or technical
...
\item A properly documented, well-formatted, and correct version of
  ...
  containing any defects that ``break the build'', it must feature additional
  comments that explain each of the mistakes that you found and a clear
  statement of the process you followed to find and fix them.
