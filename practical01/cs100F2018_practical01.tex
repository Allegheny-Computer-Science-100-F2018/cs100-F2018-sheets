...
will learn how to implement and run a Java program, also discovering how to use
the Gradle build tool and the course's automated grading tool to assess your
progress towards correctly completing the project. Finally, you will explore
how to perform character output and to use escaped characters.
...
\section*{Using Escape Characters to Display Character-Based Artwork}
