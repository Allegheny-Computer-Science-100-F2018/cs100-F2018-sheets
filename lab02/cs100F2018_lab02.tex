...
then today's date. You can accomplish the first task by typing
...
\command{System.out.println} statements. The next three lines will feature the
output of numerical values, with the final line outputting the result of a
computation with variables. Please see the Java source code comments for more
details!

% When you are finished typing Java code in \program{gvim}, press the ESC key
