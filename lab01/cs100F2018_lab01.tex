...
with a name like
``Allegheny-Computer-Science-100-Fall-2018/computer-science-100-fall-2018-lab-1-gkapfham''.
...
command \command{mkdir cs100F2018}. To enter into this directory you should now
type \command{cd cs100F2018}. Next, you can type the command \command{ls} and
