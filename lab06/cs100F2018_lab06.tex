...
\begin{lstlisting}
  git clone git@github.com:Allegheny-Computer-Science-100-F2018/computer-science-100-fall-2018-lab-6-gkapfham.git
\end{lstlisting}
...
In the second example, nothing was changed in the last line---the {\tt
ManipulateDNA} program randomly replaced the letter ``{\tt A}'' with the letter
``{\tt A}''! This behavior is acceptable.
...
You should also write a paragraph that describes your strategy for manipulating
the DNA {\tt String}.
...
points to remember for creating programs that manipulates DNA:
