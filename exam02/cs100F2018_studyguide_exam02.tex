...
\begin{itemize}
  ...
  \item How the Java programming language supports the passing of parameters
    between methods
...
\begin{itemize}
  ...
  \item An understanding of why an infinite recursion can cause a Java program to crash
  \item Basic knowledge of how recursion can solve advanced problems such as maze navigation
  % \item Some practical applications of recursive methods (e.g., the {\tt sum} method)
