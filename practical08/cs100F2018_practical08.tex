...
\newcommand{\assignmentduedate}{December 10}
\newcommand{\assignmentassignedate}{December 7}
...
``Allegheny-Computer-Science-111-Fall-2018/computer-science-111-fall-2018-practical-8-gkapfham''. Unless you provide the
...
terminal window. If your work does not meet all of the assignment's
...
% Since this is
% another challenging practical assignment and you are continuing to learn how to
% repeat actions with \program{for} loops, don't become frustrated if you make a
...
\item A correct version of \mainprogramsource{} that meets all of the
  ...
  output. Please paste the output from your program at the bottom of this source
  code file in the form of a comment. Students may ask the instructor for help
  with pasting the output into the file.
...
evidenced by either a red \naughtmark{} in your commit listing or the absence of
a functioning GitHub repository for this practical assignment, after the set
deadline for completing the project. Please see the course instructor if you do
not understand how practical assignments are graded or you do not know how to
