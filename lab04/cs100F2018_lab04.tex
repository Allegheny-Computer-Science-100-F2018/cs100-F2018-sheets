...
src/main/java/labfour/DisplayGraphicalScene.java} in your terminal window.
Students may also take a similar step to view and edit the Java source code with
...
designated output. You should see your name, today's date, and the graphical
...
\item A complete and correct version of \mainprogramsource{} that both meets all
  of the established requirements and produces the desired output.

\item A complete and correct version of \secondprogramsource{} that both meets
  all of the established requirements and produces the desired output.
